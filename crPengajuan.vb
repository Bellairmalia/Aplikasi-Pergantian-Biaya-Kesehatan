...
Public Class crPengajuan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Aplikasi_Pergantian_Biaya_Kesehatan.crPengajuan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrPengajuan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crPengajuan = New crPengajuan()
        rpt.Site = Me.Site
        Return rpt
    End Function
